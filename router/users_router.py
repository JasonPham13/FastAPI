...
@router.post("/", response_description="Sucessfully created user", description="Creates a user", response_model=UserModel, status_code=201, responses={400: {"model": MessageModel}})
...
@router.put("/{username}", response_description="Sucessfully updated user info", description="Update a single user record", status_code=204, responses={204: {"model": None}, 400: {"model": MessageModel}, 404: {"model": MessageModel}})
...
@router.delete("/{username}", response_description="Sucessfully deleted user", description=" Deletes user by username", status_code=204, responses={204: {"model":None}})
